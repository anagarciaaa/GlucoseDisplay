...
package io.hammerhead.samplemodule.PartnerPower;
...
public class PartnerPowerDataType extends SdkDataType {
    public PartnerPowerDataType(@NotNull SdkContext context) {
        super(context);
    }
