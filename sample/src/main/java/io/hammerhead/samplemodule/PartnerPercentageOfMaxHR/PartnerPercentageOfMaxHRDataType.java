...
package io.hammerhead.samplemodule.PartnerPercentageOfMaxHR;
...
public class PartnerPercentageOfMaxHRDataType extends SdkDataType {
    public PartnerPercentageOfMaxHRDataType(@NotNull SdkContext context) {
        super(context);
    }
    ...
    public String getDescription() {
        return "Display partner % of max heart rate";
    }
