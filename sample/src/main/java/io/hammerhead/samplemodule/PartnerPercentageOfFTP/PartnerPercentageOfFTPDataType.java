...
package io.hammerhead.samplemodule.PartnerPercentageOfFTP;
...
public class PartnerPercentageOfFTPDataType extends SdkDataType {
    public PartnerPercentageOfFTPDataType(@NotNull SdkContext context) {
        super(context);
    }
    ...
    public String getDescription() {
        return "Display partner % of FTP";
    }

    @NotNull
    @Override
    public List<Dependency> getDependencies() {
        return Arrays.asList(Dependency.POWER);
    }
